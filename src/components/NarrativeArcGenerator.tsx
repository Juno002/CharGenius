...
import { TrendingUp, Loader2, Sparkles, AlertTriangle, Cpu } from 'lucide-react';
...
export function NarrativeArcGenerator() {
    const { character, apiProvider, isAiDisabled, language } = useCharacter();
            ...
            <Card className="glass-card">
                <CardHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <CardTitle className="font-space-grotesk text-2xl">Generador de Arcos Narrativos</CardTitle>
                            <CardDescription>
                                Propone trayectorias de crecimiento y conflicto para la historia de <span className="font-bold text-accent">{character.data.name}</span>, basadas en su arquetipo.
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
            ...
            <AnimatePresence>
                ...
                {arcsResult && (
                     <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                        <Card className="glass-card">
                             <CardHeader>
                                <CardTitle>Arcos Narrativos Sugeridos</CardTitle>
